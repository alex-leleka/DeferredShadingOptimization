...
enum {
    ...
    UI_VISUALIZEPEROPTIMIZEDSAMPLES,
    UI_LIGHTINGONLY,
    UI_LIGHTS,
    UI_LIGHTSTEXT,
    UI_LIGHTSPERPASS,
...
void InitUI()
{
    ...
    // Generic HUD
    {
        ...
        HUD->AddCheckBox(UI_VISUALIZEPEROPTIMIZEDSAMPLES, L"Visualize Adaptive Samples.", 0, y, width, 23, gUIConstants.visualizeOptimizedPixels != 0);
        y += 26;
        ...
        gCullTechniqueCombo->AddItem(L"Compute Adaptive Shading", ULongToPtr(CULL_COMPUTE_SHADER_OPTIMIZED));
...
void CALLBACK OnGUIEvent(UINT eventID, INT controlID, CDXUTControl* control, void* userContext)
{
    switch (controlID) {
        ...
        case UI_VISUALIZEPEROPTIMIZEDSAMPLES:
            gUIConstants.visualizeOptimizedPixels = dynamic_cast<CDXUTCheckBox*>(control)->GetChecked(); break;
